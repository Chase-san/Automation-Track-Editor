...
public class RightWalker implements ITrackWalker {
	...
	public TrackState nextState(TrackState state, TrackSegment segment) {
		...
		next.shape = new Arc2D.Double(centerX - radius2d, centerY - radius2d, radius2d * 2, radius2d * 2, 90 - Math.toDegrees(state.angle), // start
